...
function canvotee(age){
    if(age>=18){
        return `it can vote`;

    }else{
        return 'it cannot vote ';

    }

}

let vote = canvotee(18);//
console.log(vote);// can vote 
let votee = canvotee(19);
console.log(votee)// can vote 
let voteee = canvotee(17);
console.log(voteee);// cant vote
